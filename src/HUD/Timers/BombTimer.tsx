  ...
  render() {
    ...
    return (
      <div id={`bomb_container`}>
        <div className={`bomb_timer ${this.state.show && !this.props.winState ? "show" : "hide"}`} style={{ width: `${100 - this.state.width}%` }}></div>
        <div className="container">
          ...
          <div className="bomb_text">{this.state.show ? bomb_time : null}</div>
        </div>
